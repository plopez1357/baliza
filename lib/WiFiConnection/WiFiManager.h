...
const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/wifi\" method=\"get\"><button>Escanear redes disponibles</button></form><br/><form action=\"/0wifi\" method=\"get\"><button>Acceder a una red</button></form><br/>";
